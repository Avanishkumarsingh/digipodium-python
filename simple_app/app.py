...
# view categories
if st.checkbox(lebel='View Categories'):
...
category = form2.text_input(lebel='Category Id')
submit = form.form_submit_button(label='Add Product')
if submit:
    add_product(name, category)

# view products
if st.checkbox(lebel='View_Products'):
